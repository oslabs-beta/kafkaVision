...
const Sidebar = () => {
  ...
  let displayedBoxes: JSX.Element[] = [];
  const buttonText: string[] = ['Connect Cluster', 'Health Metrics', 'Partition Diagrams', 'Topic Metrics'];
  const urlsText: string[] = ['/connectCluster', '/health', '/componentRelationships', '/topicMetrics'];
  const roles: string[] = ['cluster_button', 'health_button', 'component_button', 'topic_button']
  for (let i = 0; i < 4; i += 1) {
