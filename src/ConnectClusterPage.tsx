...
const ConnectClusterPage = () => {
    ...
    return(
        <div className='flex flex-col text-fontGray/70 border rounded border-limeGreen/70 m-10 bg-zinc-800'>
            <div className="flex place-content-center font-bold text-xl m-5 text-fontGray-75"> 
                ...
                <div className='border rounded m-10 border-seafoam/80 bg-slateBlue/80'>
                  <div className="flex place-content-center">
                      ...
                      <input onChange={handleKafkaInput} placeholder="Kafka Broker Port" name="urlKafka" id="urlKafka" value={url_kafka} className="m-8 rounded bg-slateBlue border border-limeGreen/80" type="text"></input>
